  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: "0 20px 20px", borderBottom: "0.5px solid #1e1e2e", marginBottom: "16px" }}>
        <p style={{ fontSize: "13px", fontWeight: 500, color: "#7c6af7", letterSpacing: "0.08em", textTransform: "uppercase", margin: 0 }}>CMS Suite</p>
        <p style={{ fontSize: "10px", color: "#3a3a5a", marginTop: "2px", marginBottom: 0 }}>Content Management</p>
      </div>
      <p style={{ fontSize: "9px", fontWeight: 500, color: "#3a3a5a", letterSpacing: "0.1em", textTransform: "uppercase", padding: "0 20px 8px", margin: 0 }}>Workspace</p>
